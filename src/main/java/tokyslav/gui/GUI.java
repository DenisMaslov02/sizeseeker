...
public class GUI {
    ...
    // RenamButton.addActionListener(e ->
    // getInDriveCenterPanel(tempNameFile.toString()));
    ...
    // Image scaledImg = driveIcon.getImage().getScaledInstance(26, 26,
    // Image.SCALE_SMOOTH);
    // driveIcon = new ImageIcon(scaledImg);

    // RenameJPanel.setBackground(Color.white);
    // RenameJPanel.add(new JLabel(tempNameFile.toString(), driveIcon,
    // JLabel.LEFT));
    ...
    // private void goToParentFunction(String tempActualPath) {
    // String actualPath = filereader.getParent(tempActualPath);
    // recreateCenterJPanel(actualPath);
    // setactualPathJLabelText(actualPath);
    // }

    // private void goToHomeFunction() {
    // frame.getContentPane().removeAll();
    // frame.revalidate();
    // frame.repaint();
    // startGUIJPanel();
    ...
    // int[] percentageOfSizeIntArray =
    // GUILogic.calculatePercentage(fileobjectArray);

    // for (int i = 0; i < fileobjectArray.length; i++) {
    // centerJPanel.add(createFileObjectPanel(fileobjectArray[i],
    // percentageOfSizeIntArray[i]));
    // }
    // JScrollPane scrollpanel = new JScrollPane(centerJPanel);
    // return scrollpanel;
    // }

    // private JPanel createFileObjectPanel(Fileobject tempFileobject, int
    // percentageOfSize) {
    ...
    // openFileExplorer(tempFileobject.getFileName()));
    // buttonToPress.add(iconButton, BorderLayout.LINE_START);
    // // NAME
    // JLabel fileNameLabel = customJLabel(tempFileobject.getFileName(),
    // percentageOfSize);
    ...
    // buttonToPress.addActionListener(e ->
    // recreateCenterJPanel(tempFileobject.getFileName()));
    ...
    // ImageIcon icon = new
    // ImageIcon(getImagePath(fileobjectForIcon.getFileType()));
